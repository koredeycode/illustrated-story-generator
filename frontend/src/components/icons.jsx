const PATHS = {
  ...
  sparkles: <path d="M12 2c.6 4.8 2.2 6.4 7 7-4.8.6-6.4 2.2-7 7-.6-4.8-2.2-6.4-7-7 4.8-.6 6.4-2.2 7-7z" />,
  image: (
    <>
  ...
  cloud: <path d="M17.5 19a4.5 4.5 0 1 0-.4-9A6 6 0 0 0 5.4 11.6 4 4 0 0 0 6 19h11.5z" />,
  alert: (
    <>
